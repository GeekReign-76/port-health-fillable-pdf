...
else
{
	...
	if (__cfclient_os != undefined && __cfclient_os != null)
	{
		if (__cfclient_os == "ios")
			__cfclient_cordovaJSPath = window.cfclientPath + "cf_scripts/cfclient/dnfi/cordova-ios.js";
		else if (__cfclient_os == "android")
			__cfclient_cordovaJSPath = window.cfclientPath + "cf_scripts/cfclient/dnfi/cordova-android.js";
