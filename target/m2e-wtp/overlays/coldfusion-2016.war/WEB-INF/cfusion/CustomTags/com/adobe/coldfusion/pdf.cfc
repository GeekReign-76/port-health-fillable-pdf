...
component extends="base"
{
    ...
    /**
     * Archives a pdf document.
	 * @return Pdf (If name attribute is specified) or an empty string
     * @output false
     */
	public any function archive()
    {
    	 return invoketag(arguments,"archive");
    }    
	 /**
     * Unsigns a pdf document.
	 * @return Pdf (If name attribute is specified) or an empty string
     * @output false
     */
	public any function unsign()
    {
    	 return invoketag(arguments,"unsign");
    }    
	/**
    ...
    {
    	 return invoketag(arguments,"sign");
    }   
	/**
     * validates signatures a pdf document.
	 * @return struct containing list of failed signatures and a boolean indicating if all signatures are validated or not
     * @output false
     */
	public any function readsignaturefields()
    {
    	 return invoketag(arguments,"readsignaturefields");
    } 
	public any function validatesignature()
    {
    	 return invoketag(arguments,"validatesignature");
    }   
	public any function redact()
	{
		return invoketag(arguments,"redact");
	}
	public any function sanitize()
	{
		return invoketag(arguments,"sanitize");
	}
	public any function addStamp()
	{
		return invoketag(arguments,"addStamp");
	}
	public any function importAny()
	{
		return invoketag(arguments,"import");
	}
	public any function exportAny()
	{
		return invoketag(arguments,"export");
	}
	public any function addAttachments()
	{
		return invoketag(arguments,"addAttachments");
	}
