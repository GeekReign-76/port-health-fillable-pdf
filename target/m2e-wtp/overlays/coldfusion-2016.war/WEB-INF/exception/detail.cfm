...
<cfif thistag.executionmode is "start">
    ...
    <cftry>
        <cfif FileExists(GetDirectoryFromPath(GetCurrentTemplatePath()) & "/exception_#locale#.cfm")>
            <cfinclude template="exception_#locale#.cfm">
        <cfelse>
            <cfinclude template="exception_en.cfm">
        </cfif>
        <cfcatch>
            <cfinclude template="exception_en.cfm">
        </cfcatch>
...
<cfelse> <!--- body falls here --->
    ...
    <tr>
        <td id="tableProps2" align="left" valign="middle" width="500">
            ...
            #encodeForErrorSmart(attributes.message)#
            </h1>
        </td>
    </tr>
    <tr>
        <td id="tablePropsWidth" width="400" colspan="2">
            <font style="COLOR: black; FONT: 8pt/11pt verdana">
            #encodeForErrorSmart(attributes.detail)#
            </font>
        </td>
    </tr>
    <tr>
    	...
    	<cfif arraylen(vcfml) gt 0>
    		...
    		<cfif not vcfml[1]contains "-1">
        		<tr>
        			...
        			#s_error_in# <b>#encodeForErrorSmart(vcfml[1])#</b><br>

        			<cfif arraylen(vcfml) gt 2>
        				<cfloop index="i" from="2" to="#arraylen(vcfml)#">
        					<b>#s_called_from#</b> #encodeForErrorSmart(vcfml[i])#<br>
        				</cfloop>
        			</cfif>
        			</td>
        		</tr>
